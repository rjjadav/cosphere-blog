...
mCtrls.controller('BlogController', BlogController);

BlogController.$inject = ['$state','$facebook'];

function BlogController($state, $facebook){
	var blog = this;

	blog.shareOnFacebook = shareOnFacebook;
	...
	blog.blogContents = [
		...
		},
		{
			...
			content: '<p><a href="http://cosphere.in"><img class="aligncenter size-medium wp-image-26" src="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi_1-300x253.png" alt="Ruchi_1" width="300" height="253" srcset="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi_1-300x253.png 300w, http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi_1.png 593w" sizes="(max-width: 300px) 100vw, 300px"><img class="aligncenter size-medium wp-image-22" src="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-2-300x219.png" alt="Ruchi 2" width="300" height="219" srcset="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-2-300x219.png 300w, http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-2.png 595w" sizes="(max-width: 300px) 100vw, 300px"></a><br><img class="aligncenter size-medium wp-image-23" src="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-3-300x225.png" alt="Ruchi 3" width="300" height="225" srcset="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-3-300x225.png 300w, http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-3.png 598w" sizes="(max-width: 300px) 100vw, 300px"> <img class="aligncenter size-medium wp-image-24" src="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-4-300x197.png" alt="Ruchi 4" width="300" height="197" srcset="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-4-300x197.png 300w, http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-4.png 596w" sizes="(max-width: 300px) 100vw, 300px"><br><img class="aligncenter size-medium wp-image-25" src="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-5-300x262.png" alt="Ruchi 5" width="300" height="262" srcset="http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-5-300x262.png 300w, http://blog.cosphere.in/wp-content/uploads/2016/06/Ruchi-5.png 591w" sizes="(max-width: 300px) 100vw, 300px"></p>',
			contentImage: null,
	...
	blog.selectedBlog = blog.blogContents.filter(function(obj){
		return obj.id == $state.params.blogId;
	})[0];


	function shareOnFacebook(selectedBlog){
		// console.log(selectedBlog);
		
		$facebook.ui({
			method: 'feed',
			name: selectedBlog.blogTitle,
			link: 'http://45.56.97.181:8080/blog/#/blog/'+selectedBlog.id,
			picture: selectedBlog.imageSrc,
			caption: 'cosphere.in',
